...
namespace Id3Lib
{
    ...
    public class ID3v1
    {
        ...
        private static string GetString(Encoding encoding, byte[] tag)
        {
            ...
            return index < 0 ? encoding.GetString(tag,0,tag.Length) : encoding.GetString(tag, 0, index);
        }
        /// <summary>
        ...
        public void Deserialize(Stream stream)
        {
            ...
            var encoding = new ID3Lib_PCL.Utils.AsciiEncoding(); //Encoding.GetEncoding("1252"); // Should be ASCII
            // check for ID3v1 tag
